...
import interfaces.segundaAula.primeiraRefatoracao.model.util.Formatter;
...
import interfaces.segundaAula.primeiraRefatoracao.model.service.RentalService;
...
public class Main {
    public static void main(String[] args) {
        ...
        try (Scanner sc = new Scanner(System.in)) {
            ...
            RentalService rentalService = new RentalService(); // Instância
            rentalService.processInvoice(carRental, priceHour, priceDay);
